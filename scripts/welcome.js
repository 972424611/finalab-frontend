	;(function(main) {
		...
		txtCtx.fillText('w e l c o m e', WIDTH / 2, HEIGHT / 2 - 20);

		txtCtx.fillText('t o', WIDTH / 2, HEIGHT / 2 + 80);
		txtCtx.fillText('F i n a l L a b', WIDTH / 2, HEIGHT / 2 + 180);

		ctx.font = 'bold 0px Monospace';
